...
router.post('/', (0, auth_1.auth)(user_const_1.USER_ROLE.admin), (0, validateRequest_1.validateRequest)(room_validation_1.RoomValidations.createRoomValidationSchema), room_controller_1.RoomControllers.createRoom);
